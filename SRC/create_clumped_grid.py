...
def create_clumped_grid(tile_size, align_raster, output='clumped_grid'):
    '''
    ...
    '''
    gscript.run_command('g.region', raster=align_raster, res=tile_size)
    ...
    gscript.run_command('r.mask', quiet=True, raster=align_raster)
